...
const MODES: Mode[] = [
  {
    ...
    description: 'Daily wake-up battles. Whoever wakes up first wins the day. Weekly loser pays.',
    stakes: '$5-20/week',
    players: '2 people',
    color: '#FB923C',
    features: ['Daily winner/loser', 'Weekly payout', 'See their snoozes'],
  },
  {
    id: 'group',
    icon: 'users',
    ...
    description: 'Everyone contributes weekly. Person with most wake-ups takes the whole pot.',
    stakes: '$5-10/person',
    players: '3-8 people',
    color: '#22C55E',
    features: ['Winner takes all', 'Group leaderboard', 'Shame the losers'],
  },
  {
    id: 'survivor',
    icon: 'target',
    ...
    description: "Miss a wake-up? You're eliminated. Last person standing wins the pot.",
    stakes: '$10-50 buy-in',
    players: '4-12 people',
    color: '#EF4444',
  ...
  },
  {
    ...
    description: 'Get notified when your partner snoozes. Send nudges. Build streaks together.',
    stakes: 'Free',
    players: '2 people',
    color: '#7C3AED',
  ...
  },
  {
    ...
    subtitle: 'Snooze = donate to cause',
    description: 'Every time you snooze, money goes to a charity. Pick one you hate for motivation.',
    stakes: '$1-5/snooze',
