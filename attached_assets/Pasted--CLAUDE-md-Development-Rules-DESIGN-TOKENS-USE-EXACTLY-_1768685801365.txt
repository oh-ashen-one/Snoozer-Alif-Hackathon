...
### StyleSheet Pattern
Always use StyleSheet.create, never inline styles repeated more than once.

### Async Operations
Always wrap in try/catch with error handling.

### Camera Pattern
Use useRef for camera, takePictureAsync with quality 0.7.

### Audio
Always set playsInSilentModeIOS: true for audio playback.
